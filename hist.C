...
void hist::Loop()
{
   ...
   TH1F* Res_spec_En1 = new TH1F("Res_spec_En1","Res_spec_En1",200,-1,1);
   TH1F* Res_spec_En2 = new TH1F("Res_spec_En2","Res_spec_En2",200,-1,1);
   ...
   TH1F* Res_spec_Th1 = new TH1F("Res_spec_Th1","Res_spec_Th1",200,-0.1,0.1);
   TH1F* Res_spec_Th2 = new TH1F("Res_spec_Th2","Res_spec_Th2",200,-0.1,0.1);
   ...
   TH1F* Res_spec_Ph1 = new TH1F("Res_spec_Ph1","Res_spec_Ph1",200,-0.05,0.05);
   TH1F* Res_spec_Ph2 = new TH1F("Res_spec_Ph2","Res_spec_Ph2",200,-0.05,0.05);
   ...
   TH1F* MMProt2Neut = new TH1F("MMProt2Neut","MMProt2Neut",200,938,942);
   ...
   TCanvas *Residuals = new TCanvas("Residuals","Residuals",1000,1000);
   Residuals->Divide(3,3);
   TCanvas *QA_res = new TCanvas("QA_res","QA_res",1000,1000);
   QA_res->Divide(3,3);
   TCanvas *Pull = new TCanvas("Pull","Pull",1000,1000);
   Pull->Divide(3,3);
